...
"""
Grape Disease Analysis Pipeline with Hailo8L AI Acceleration
===========================================================
...
with Hailo8L AI hardware acceleration. It provides a complete end-to-end solution
...
optimal hardware resource management and prevent conflicts between Hailo8L AI accelerator
...
.. module:: init_grape_diseases_Hailo8L
...
Hardware Integration:
    - **Hailo8L AI Acceleration**: Hardware-optimized neural network inference
...
- **AI Acceleration**: Hailo8L hardware optimization for real-time field processing
...
Grape Disease Analysis Pipeline:
    ...
    2. **Leaf Detection**: YOLOv8n leaf identification with Hailo8L acceleration
...
AI Model Integration:
    ...
    - **Hailo8L Optimization**: Hardware-specific model compilation and acceleration
...
AI Model Dependencies:
    - **leaf_detection_Hailo8L.py**: YOLOv8n leaf detection with Hailo8L acceleration
    - **grape_diseases_Hailo8L.py**: Disease classification neural network
    - **Hailo8L Runtime**: Hardware acceleration environment and drivers
...
AI Model Integrations:
    ...
    - **Hailo8L Platform**: Hardware optimization and acceleration management
...
Multi-level Error Management:
    ...
    - **Hardware Management**: Hailo8L accelerator resource conflict prevention
...
See Also
--------
leaf_detection_Hailo8L : YOLOv8n leaf detection with Hailo8L acceleration
grape_diseases_Hailo8L : Disease classification neural network
...
def run_leaf_detection(input_image: str) -> str:
    """
    Execute grape leaf detection subprocess using YOLOv8n with Hailo8L AI acceleration.
    ...
    and prevents conflicts between Hailo8L AI accelerator instances while providing
    ...
    Workflow:
        ...
        2. **Hardware Management**: Allocate Hailo8L AI accelerator resources
    ...
    Notes
    -----
    - **Subprocess Isolation**: Prevents Hailo8L hardware conflicts between model instances
    ...
    Subprocess Configuration:
        - **Script Path**: Images/Models/Grape_Diseases_Hailo8L/Leaf_Detection/leaf_detection_Hailo8L.py
    ...
    Performance Considerations:
        - **Hardware Acceleration**: Leverages Hailo8L AI for real-time processing
    ...
    leaf_detection_Hailo8L.py : YOLOv8n leaf detection implementation
    """
    try:
        # Define path to leaf detection module with YOLOv8n and Hailo8L acceleration
        # Isolated execution prevents hardware resource conflicts
        path = "Images/Models/Grape_Diseases_Hailo8L/Leaf_Detection/leaf_detection_hailo8l.py"
...
def run_disease_classification(leaf_folder: str, output_folder: str = None) -> str:
    ...
    Workflow:
        ...
        2. **Hardware Allocation**: Allocate Hailo8L AI accelerator for neural network inference
    ...
    leaf_folder : str
        ...
        Expected format: Images/Models/Grape_Diseases_Hailo8L/Leafs/{image_name}/
    ...
    >>> leaf_directory = "Images/Models/Grape_Diseases_Hailo8L/Leafs/vineyard_1/"
    ...
    Notes
    -----
    - **Subprocess Isolation**: Prevents Hailo8L hardware conflicts during neural network inference
    ...
    Subprocess Configuration:
        - **Script Path**: Images/Models/Grape_Diseases_Hailo8L/Grape_Diseases/grape_diseases_Hailo8L.py
    ...
    Disease Classification Details:
        ...
        - **Hardware Acceleration**: Hailo8L AI optimization for real-time processing
    ...
    grape_diseases_Hailo8L.py : Disease classification neural network implementation
    """
    try:
        # Define path to disease classification module with specialized grape pathology models
        # Isolated execution ensures proper Hailo8L hardware resource management
        path = "Images/Models/Grape_Diseases_Hailo8L/Grape_Diseases/grape_diseases_hailo8l.py"
...
def run(input_image: str, output_folder: str) -> dict:
    ...
    - **Hardware Optimization**: Leverages Hailo8L acceleration for real-time processing
    ...
    Pipeline Components:
        - **Leaf Detection**: YOLOv8n neural network with Hailo8L acceleration
    ...
    """
    try:
        # Execute leaf detection subprocess with YOLOv8n and Hailo8L acceleration
