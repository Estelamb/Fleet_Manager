...
import GRPC.definitions.command_pb2 as command__pb2
...
class CommandCommunicationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendCommand = channel.unary_unary(
                '/command_communication.CommandCommunication/SendCommand',
...
class CommandCommunicationServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_CommandCommunicationServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'command_communication.CommandCommunication', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('command_communication.CommandCommunication', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class CommandCommunication(object):
    """Missing associated documentation comment in .proto file."""
